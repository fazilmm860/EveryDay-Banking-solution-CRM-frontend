...
function EditPermanentAddress({ editedData, setEditedData }) {
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="flat"
                        id="flat"
                        value={editedData.permanentAddress.flat}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="street"
                        id="street"
                        value={editedData.permanentAddress.street}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="city"
                        id="city"
                        value={editedData.permanentAddress.city}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="state"
                        id="state"
                        value={editedData.permanentAddress.state}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="landMark"
                        id="landMark"
                        value={editedData.permanentAddress.landMark}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="pincode"
                        id="pincode"
                        value={editedData.permanentAddress.pincode}
...
export default EditPermanentAddress;
