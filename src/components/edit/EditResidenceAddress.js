...
function EditResidenceAddress({ editedData, setEditedData }) {
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="flat"
                        id="flat"
                        value={editedData.residenceAddress.flat}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="street"
                        id="street"
                        value={editedData.residenceAddress.street}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="city"
                        id="city"
                        value={editedData.residenceAddress.city}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="state"
                        id="state"
                        value={editedData.residenceAddress.state}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="landMark"
                        id="landMark"
                        value={editedData.residenceAddress.landMark}
            ...
            <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                        ...
                        name="pincode"
                        id="pincode"
                        value={editedData.residenceAddress.pincode}
